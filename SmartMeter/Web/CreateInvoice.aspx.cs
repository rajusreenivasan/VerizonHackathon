...
public partial class CreateInvoice : System.Web.UI.Page
{
    ...
    {
        Common oCommon = new SmartMeter.Data.Common();
        gvCustomer.DataSource = oCommon.GetCustomers();
        gvCustomer.DataBind();
    }
    ...
    protected void gvCustomer_PageIndexChanged(object sender, GridViewPageEventArgs e)
    {
    }
